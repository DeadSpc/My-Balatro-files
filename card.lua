...
function Card:generate_UIBox_ability_table()
    ...
    elseif self.ability.set == 'Joker' then -- all remaining jokers
        ...
        elseif self.ability.name == 'Fortuno' then loc_vars = {self.ability.extra.dollars}
        elseif self.ability.name == 'Feste' then loc_vars = {self.ability.extra}
        elseif self.ability.name == 'Stanczyk' then loc_vars = {self.ability.extra.loop_amount}
        elseif self.ability.name == 'Midnight Crew' then loc_vars = {self.ability.extra.suit, self.ability.extra.x_mult, colours = { G.C.SUITS[self.ability.extra.suit] }}
        elseif self.ability.name == 'Self Portrait' then loc_vars = {self.ability.extra.ability_loc_txt,self.ability.extra.ability_state, self.ability.extra.x_mult}
        elseif self.ability.name == 'Devoted' then loc_vars = {self.ability.extra.x_mult, self.ability.extra.x_mult_gain}
        elseif self.ability.name == 'Boredom Slayer' then loc_vars = {(1 - self.ability.extra.reduction) * 100} 
        elseif self.ability.name == 'Devilish Joker' then loc_vars = {self.ability.extra.x_mult}
        elseif self.ability.name == 'Impractical Joker' then loc_vars = {self.ability.extra.x_mult, self.ability.extra.poker_hand} 
        elseif self.ability.name == 'Wanted Poster' then loc_vars = {self.ability.extra.dollars, self.ability.extra.penalty}  
        elseif self.ability.name == 'Suspicious Vase' then loc_vars = {self.ability.extra}
        elseif self.ability.name == 'Memorable Joker' then loc_vars = {self.ability.extra, self.ability.x_mult}
        elseif self.ability.name == 'Tapestry Joker' then loc_vars = {self.ability.extra.mult, self.ability.extra.mult_gain, self.ability.extra.tapestry_list}     
        elseif self.ability.name == 'Sentai Joker' then loc_vars = {self.ability.extra, self.ability.mult}
        elseif self.ability.name == 'Pawn Joker' then loc_vars = {G.GAME.probabilities.normal, self.ability.extra.odds, self.ability.extra.dollars}
        elseif self.ability.name == 'Expanded Art Joker' then loc_vars = {self.ability.extra.chips}
        elseif self.ability.name == 'Highlander Joker' then loc_vars = {self.ability.extra.chip_bonus}
        elseif self.ability.name == 'Scrapper Joker' then loc_vars = {G.GAME.probabilities.normal, self.ability.extra.odds}
        elseif self.ability.name == 'Sir Joker' then loc_vars = {self.ability.extra.x_mult}
        elseif self.ability.name == 'Makeshift Joker' then loc_vars = {self.ability.extra, self.ability.mult}
        elseif self.ability.name == 'Minimalist Joker' then loc_vars = {self.ability.extra.mult}
        elseif self.ability.name == 'Ternary System' then loc_vars = {self.ability.extra.poker_hand}
        elseif self.ability.name == 'Chicken Scratch' then loc_vars = {self.ability.extra.chips, self.ability.extra.chips_gain}
        elseif self.ability.name == 'Chalk Outline' then loc_vars = {self.ability.extra.mult, self.ability.extra.mult_gain}
        elseif self.ability.name == 'Cardslinger' then loc_vars = {self.ability.extra.trigger_count, self.ability.extra.chips, self.ability.extra.clear_cache}
        elseif self.ability.name == 'Pitiful Joker' then loc_vars = {self.ability.extra.mult}
        elseif self.ability.name == 'Sunday Funnies' then loc_vars = {self.ability.extra.counter}
        elseif self.ability.name == 'Studious Joker' then loc_vars = {self.ability.mult}
        elseif self.ability.name == 'Bottled Buffoon' then loc_vars = {self.ability.extra.every + 1, localize{type = 'variable', key = (self.ability.loyalty_remaining == 0 and 'loyalty_active' or 'loyalty_inactive'), vars = {self.ability.loyalty_remaining}}}
        elseif self.ability.name == 'Mutated Joker' then loc_vars = {self.ability.extra.chips, G.alchemical_tally * self.ability.extra.chips}
        elseif self.ability.name == 'Essence of Comedy' then loc_vars = {self.ability.extra, self.ability.x_mult}
        elseif self.ability.name == 'Shock Humor' then loc_vars = {''..(G.GAME and G.GAME.probabilities.normal or 1), self.ability.extra.odds}
        elseif self.ability.name == 'Catalyst Joker' then loc_vars = {self.ability.extra.bonus, 1 + self.ability.extra.bonus*(self.ability.consumeable_tally or 0)}  
...
function Card:use_consumeable(area, copier)
    ...
    if self.ability.name == 'Incense' then  
    ...
    if self.ability.name == 'Bismuth' then
        ...
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, self in ipairs(G.hand.highlighted) do
                self:set_edition({polychrome = true}, true)
                table.insert(G.deck.config.bismuth, self.unique_val)
            end
        return true end }))
    end
    ...
    if self.ability.name == 'Soap' then
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, _card in ipairs(G.hand.highlighted) do
                return_to_deck(self.ability.extra, _card)
            end
            G.FUNCS.draw_from_deck_to_hand(self.ability.extra)
        return true end }))
    end
    if self.ability.name == 'Manganese' then
        G.deck.config.manganese = G.deck.config.manganese or {}
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, self in ipairs(G.hand.highlighted) do
                delay(0.05)
                self:juice_up(1, 0.5)
                self:set_ability(G.P_CENTERS.m_steel)
                table.insert(G.deck.config.manganese, self.unique_val)
            end
        return true end }))
    end
    if self.ability.name == 'Wax' then
    ...
    if self.ability.name == 'Borax' then
        G.deck.config.wax = G.deck.config.wax or {}
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for i = 1, 2 do
                G.playing_card = (G.playing_card and G.playing_card + 1) or 1
    ...
    if self.ability.name == 'Glass' then
        ...
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, self in ipairs(G.hand.highlighted) do
                ...
                table.insert(G.deck.config.glass, self.unique_val)
            end
        return true end }))
    end
    if self.ability.name == 'Magnet' then
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
    ...
    if self.ability.name == 'Gold' then
        ...
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, self in ipairs(G.hand.highlighted) do
                ...
                table.insert(G.deck.config.gold, self.unique_val)
            end
        return true end }))
    end
    if self.ability.name == 'Silver' then
        G.deck.config.silver = G.deck.config.silver or {}
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for k, self in ipairs(G.hand.highlighted) do
                delay(0.05)
                self:juice_up(1, 0.5)
                self:set_ability(G.P_CENTERS.m_lucky)
                table.insert(G.deck.config.silver, self.unique_val)
            end
        return true end }))
    end
    if self.ability.name == 'Oil' then
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
    ...
    if self.ability.name == 'Acid' then
    ...
    if self.ability.name == 'Brimstone' then
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            ease_discard(self.ability.extra)
            ease_hands_played(self.ability.extra)
            for i = 1, #G.jokers.cards do
    ...
    if self.ability.name == 'Uranium' then
        ...
        G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            for i = 1, 3 do
                ...
                if #eligible_cards > 0 then
                    local conv_card = pseudorandom_element(eligible_cards, pseudoseed(self.ability.name))
    ...
    if self.config.in_booster and (self.ability.set == "Alchemical" or self.ability.name == "Philosopher's Stone") then
        ...
        local center_obj = G.P_CENTER_POOLS.Alchemical[key]
    ...
    if self.ability.name == 'The Seeker' then
        local used_tarot = (copier or self)
...
function Card:can_use_consumeable(any_state, skip_check)
    ...
    if self.ability.name == 'Philosopher stone' then
        if G.STATE == G.STATES.SELECTING_HAND then
            self.config.in_booster = false
            return true
        end
    ...
    if G.STATE ~= G.STATES.HAND_PLAYED and G.STATE ~= G.STATES.DRAW_TO_HAND and G.STATE ~= G.STATES.PLAY_TAROT or any_state then
        if (self.ability.name == 'Ignis' or self.ability.name == 'Aqua' or self.ability.name == 'Terra' or self.ability.name == 'Aero' or
            self.ability.name == 'Quicksilver' or self.ability.name == 'Salt' or self.ability.name == 'Sulfur' or self.ability.name == 'Phosphorus' or
            self.ability.name == 'Arsenic' or self.ability.name == 'Antimony' or self.ability.name == 'Oil' or self.ability.name == 'Brimstone') then
            return true
        end
        if self.ability.name == 'Cobalt' then
        ...
        if (self.ability.name == 'Bismuth' or self.ability.name == 'Soap' or self.ability.name == 'Manganese' or self.ability.name == 'Wax' or
            self.ability.name == 'Borax' or self.ability.name == 'Glass' or self.ability.name == 'Magnet' or self.ability.name == 'Gold' or
            self.ability.name == 'Silver' or self.ability.name == 'Acid' or self.ability.name == 'Uranium') then
...
function Card:apply_to_run(center)
    ...
    if center_table.name == 'Alchemical Merchant' or center_table.name == 'Alchemical Tycoon' then
        G.E_MANAGER:add_event(Event({func = function()
        G.GAME.alchemical_rate = 4*center_table.extra
        return true end }))
    end
    ...
    if self.ability.set == "Joker" and not self.debuff then
        ...
        elseif context.selling_card then
                ...
                if self.ability.name == 'Campfire' and not context.blueprint then
                    ...
                    G.E_MANAGER:add_event(Event({
                        func = function() card_eval_status_text(self, 'extra', nil, nil, nil, {message = localize('k_upgrade_ex')}); 
                            return true
                        end}))
                end
            return
        elseif context.reroll_shop then
            if self.ability.name == 'Sunday Funnies' then
                if #G.consumeables.cards + G.GAME.consumeable_buffer < G.consumeables.config.card_limit then
        ...
        elseif context.skip_blind then
            if self.ability.name == 'Mural Menace' then
                G.E_MANAGER:add_event(Event({
                    trigger = 'after',
                    delay = 0.1,
                    func = function()
        ...
        elseif context.first_hand_drawn then
            ...
            if self.ability.name == 'Fortuno' and not context.blueprint then
        ...
        elseif context.setting_blind and not self.getting_sliced then
            if self.ability.name == 'Box of Stuff' and not context.blueprint and context.blind.boss then
                G.E_MANAGER:add_event(Event({
                    func = (function()
            ...
            if self.ability.name == 'Cut the Cheese' and not context.blueprint and #G.jokers.cards + G.GAME.joker_buffer < G.jokers.config.card_limit then
            ...
            if self.ability.name == 'Old Man' and not context.blueprint and context.blind.boss then
                G.E_MANAGER:add_event(Event({
                    func = (function()
            ...
            if self.ability.name == 'Devoted' and not context.blueprint and context.blind.boss then
                ease_dollars(-G.GAME.dollars, true)
            ...
            if self.ability.name == 'Self Portrait' and not context.blueprint then
                ...
                self.ability.extra.ability_loc_txt =  localize("self_portrait_"..self.ability.extra.ability_state)
                G.E_MANAGER:add_event(Event({
                    trigger = 'after',
                    delay = 0.4,
                    func = function()
        ...
        elseif context.destroying_card and not context.blueprint then
            ...
            -- if self.ability.name == 'Fortuno' and G.GAME.current_round.hands_played == 0 then
        ...
        elseif context.cards_destroyed then
            if self.ability.name == 'Self Portrait' and self.ability.extra.ability_state == 3 then
        ...
        elseif context.using_consumeable then
            if self.ability.name == 'Breaking Bozo' and not context.consumeable.config.in_booster and context.consumeable.ability.set == 'Alchemical' then
                G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.1,func = function()
            ...
            if self.ability.name == 'Essence of Comedy' and not context.consumeable.config.in_booster and context.consumeable.ability.set == 'Alchemical' then
                self.ability.x_mult = self.ability.x_mult + self.ability.extra
                G.E_MANAGER:add_event(Event({
            ...
            if self.ability.name == 'Chain Reaction' and not context.consumeable.config.in_booster and context.consumeable.ability.set == 'Alchemical' then
                if not self.ability.extra.used then
                    ...
                    card_eval_status_text(self, 'extra', nil, nil, nil, {message = "Copied", colour = G.C.SECONDARY_SET.Alchemy})
                    self.ability.extra.used = true
                    return
                end
            end
            if self.ability.name == 'Mutated Joker' and not context.consumeable.config.in_booster and context.consumeable.ability.set == 'Alchemical' then
                ...
                self.ability.extra.total_chips = G.alchemical_tally * self.ability.extra.chips
    
                G.E_MANAGER:add_event(Event({
                    func = function() card_eval_status_text(self, 'extra', nil, nil, nil, {message = localize{type='variable',key='a_chips',vars={self.ability.extra.chips}}}); return true
                    end}))
                return
            end
            ...
            if self.ability.name == 'Tapestry Joker' then
            ...
            if self.ability.name == 'Self Portrait' then
        ...
        elseif context.discard then
            ...
            if self.ability.name == 'Scrapper Joker' and context.other_card == context.full_hand[#context.full_hand] then
            ...
            if self.ability.name == 'Self Portrait' and self.ability.extra.ability_state == 5 then
                local face_cards = 0
                for k, v in ipairs(context.full_hand) do
        ...
        elseif context.end_of_round then
            if self.ability.name == 'Midnight Crew' and not context.blueprint and not (context.individual or context.repetition) then
                ...
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        play_sound('tarot1')
                        self:juice_up(0.3, 0.5)
                        G.P_CENTERS.j_midnight_crew.soul_pos.x = midnight_picker + 2
            ...
            elseif context.repetition then
                ...
                if self.ability.name == 'Stanczyk' then
            ...
            elseif not context.blueprint then
                if self.ability.name == 'Sentai Joker' and G.GAME.blind.boss and self.ability.mult > 0 then
                    self.ability.mult = 0
                    return {
        ...
        elseif context.individual then
            if context.cardarea == G.play then
                if self.ability.name == 'Cardslinger' then
                ...
                if self.ability.name == 'Suspicious Vase' then
                ...
                if self.ability.name == 'Lieutenant Jocker' then
        ...
        elseif context.repetition then
            if context.cardarea == G.play then
                ...
                if self.ability.name == 'Stanczyk' and context.other_card.ability.set == 'Enhanced' and not context.other_card.debuff then
                    return {
                        message = localize('k_again_ex'),
                        repetitions = 1,
                        card = self
        ...
        elseif context.other_joker then
            ...
            if context.cardarea == G.jokers then
                if context.before then 
                    if self.ability.name == 'Wanted Poster' then
                    ...
                    if self.ability.name == 'Boredom Slayer' then
                        G.E_MANAGER:add_event(Event({
                            trigger = 'after',
                            delay = 0.1,
                            func = function()
                    ...
                    if self.ability.name == 'Self Portrait' and not context.blueprint then   
                        if self.ability.extra.ability_state == 4 and context.full_hand and #context.full_hand <= 3 then
                            self.ability.extra.x_mult = self.ability.extra.x_mult + 0.1
                            G.E_MANAGER:add_event(Event({
                                func = function()
                                    card_eval_status_text(self, 'extra', nil, nil, nil, { message = localize('k_upgrade_ex') }); return true
                            ...
                            return
                        elseif self.ability.extra.ability_state == 6 and next(context.poker_hands['High Card']) then
                            self.ability.extra.x_mult = self.ability.extra.x_mult + 0.1
                            G.E_MANAGER:add_event(Event({
                                func = function()
                                    card_eval_status_text(self, 'extra', nil, nil, nil, { message = localize('k_upgrade_ex') }); return true
                    ...
                    if self.ability.name == 'Feste' and G.GAME.current_round.hands_played == 0 and G.GAME.blind.boss then
                        level_up_hand(card, context.scoring_name, false, self.ability.extra)
                        return {
                            card = card,
                    ...
                    if self.ability.name == 'Memorable Joker' and not context.blueprint then
                        local reset = true
                ...
                elseif context.after then
                    ...
                    if self.ability.name == 'Mutated Joker' then
                        return {
                            message = localize{type='variable',key='a_chips',vars={self.ability.extra.total_chips}},
                            chip_mod = self.ability.extra.total_chips
                        }
                    end
                    if self.ability.name == 'Studious Joker' then
                        return {
                    ...
                    if self.ability.name == 'Chalk Outline' then
                    ...
                    if self.ability.name == 'Chicken Scratch' then
                    ...
                    if self.ability.name == 'Tapestry Joker' and self.ability.extra.mult > 0 then
                        return {
                            message = localize { type = 'variable', key = 'a_mult', vars = { self.ability.extra.mult } },
                            mult_mod = self.ability.extra.mult
                        }
                    ...
                    if self.ability.name == 'Devoted' and self.ability.extra.x_mult > 1 then
                        return {
                            message = localize { type = 'variable', key = 'a_xmult', vars = { self.ability.extra.x_mult } },
                            Xmult_mod = self.ability.extra.x_mult
                        }
                    end
                    if self.ability.name == 'Midnight Crew' then
                    ...
                    if self.ability.name == 'Self Portrait' and self.ability.extra.x_mult > 1 then
                        return {
                            message = localize { type = 'variable', key = 'a_xmult', vars = { self.ability.extra.x_mult } },
                            Xmult_mod = self.ability.extra.x_mult
                        }
