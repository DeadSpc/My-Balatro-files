...
function Game:init_item_prototypes()
    ...
    self.P_TAGS = {
        ...
        tag_elemental =     {name = 'Elemental Tag',     set = 'Tag', discovered = true, min_ante = nil, order = 25, config = {type = 'new_blind_choice'}, pos = {x = 0,y = 4}},
    ...
    self.P_CENTERS = {
        ...
        j_fortuno=          {order = 151,  unlocked = true, discovered = true, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Fortuno", pos = {x=5,y=19}, soul_pos = {x=0, y=20}, set = "Joker", effect = "", config = {extra = {dollars = 3, trash_list = {}}}, unlock_condition = {type = '', extra = '', hidden = true}},
        j_feste=            {order = 152,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Feste", pos = {x=4,y=19}, soul_pos = {x=9, y=19}, set = "Joker", effect = "", config = {extra = 4}, unlock_condition = {type = '', extra = '', hidden = true}},
        j_stanczyk=         {order = 153,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Stanczyk", pos = {x=7,y=19}, soul_pos = {x=2, y=20}, set = "Joker", effect = "", config = {extra = {loop_amount = 1}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_midnight_crew=    {order = 154,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Midnight Crew", pos = {x=8,y=19}, soul_pos = {x=3, y=20}, set = "Joker", effect = "", config = {extra = {suit = "Spades", x_mult = 1}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_self_portrait=    {order = 155,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Self Portrait", pos = {x=3,y=18}, set = "Joker", effect = "", config = {extra = {ability_loc_txt =  "use a Tarot card", ability_state = 1, x_mult = 1}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_devoted=          {order = 156,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Devoted", pos = {x=0,y=17}, set = "Joker", effect = "", config = {extra = {x_mult = 1, x_mult_gain = 0.5}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_old_man=          {order = 157,  unlocked = true, discovered = true, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Old Man", pos = {x=0,y=18}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_lieutenant=       {order = 158,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Lieutenant Jocker", pos = {x=4,y=17}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_shady_dealer=     {order = 159,  unlocked = true, discovered = true, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 3, cost = 10, name = "Shady Dealer", pos = {x=5,y=18}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_cut_the_cheese=   {order = 160,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Cut the Cheese", pos = {x=8,y=16}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_boredom_slayer=   {order = 161,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Boredom Slayer", pos = {x=2,y=16}, set = "Joker", effect = "", config = {extra = {reduction = 0.9}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_devilish=         {order = 162,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Devilish Joker", pos = {x=9,y=16}, set = "Joker", effect = "", config = {extra = {x_mult = 3}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_mural_menace=     {order = 163,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Mural Menace", pos = {x=9,y=17}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_impractical=      {order = 164,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Impractical Joker", pos = {x=3,y=17}, set = "Joker", effect = "", config = {extra = {x_mult = 3, poker_hand = 'High Card'}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_box_of_stuff=     {order = 165,  unlocked = true, discovered = true, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 5, name = "Box of Stuff", pos = {x=3,y=16}, set = "Joker", effect = "", config = {extra = {}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_wanted_poster=    {order = 166,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Wanted Poster", pos = {x=3,y=19}, set = "Joker", effect = "", config = {extra = {dollars = 10, penalty = 2}}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_suspicious_vase=  {order = 167,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Suspicious Vase", pos = {x=8,y=18}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_memorable=        {order = 168,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Memorable Joker", pos = {x=6,y=17}, set = "Joker", effect = "", config = {extra = 0.1, x_mult = 1},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_tapestry=         {order = 169,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Tapestry Joker", pos = {x=9,y=18}, set = "Joker", effect = "", config = {extra = {mult = 0, mult_gain = 4, tapestry_list = {}}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_sentai=           {order = 170,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Sentai Joker", pos = {x=4,y=18}, set = "Joker", effect = "", config = {extra = 8, mult = 0},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_pawn=             {order = 171,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Pawn Joker", pos = {x=1,y=18}, set = "Joker", effect = "", config = {extra = {odds = 2, dollars = 3}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_expanded_art=     {order = 172,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Expanded Art Joker", pos = {x=1,y=17}, set = "Joker", effect = "", config = {extra = {chips = 30}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_highlander=       {order = 173,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Highlander Joker", pos = {x=2,y=17}, set = "Joker", effect = "", config = {extra = {chip_bonus = 20}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_scrapper=         {order = 174,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Scrapper Joker", pos = {x=0,y=16}, set = "Joker", effect = "", config = {extra = {odds = 3}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_sir=              {order = 175,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Sir Joker", pos = {x=6,y=18}, set = "Joker", effect = "", config = {extra = {x_mult = 1.5}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_makeshift=        {order = 176,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Makeshift Joker", pos = {x=5,y=17}, set = "Joker", effect = "", config = {extra = 1, mult = 0},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_minimalist=       {order = 177,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Minimalist Joker", pos = {x=8,y=17}, set = "Joker", effect = "", config = {extra = {mult = 10}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_ternary_system=   {order = 178,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Ternary System", pos = {x=0,y=19}, set = "Joker", effect = "", config = {extra = {poker_hand = 'Three of a Kind'}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_chicken_scratch=  {order = 179,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Chicken Scratch", pos = {x=6,y=16}, set = "Joker", effect = "", config = {extra = {chips = 0, chips_gain = 5}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_chalk_outline=    {order = 180,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Chalk Outline", pos = {x=5,y=16}, set = "Joker", effect = "", config = {extra = {mult = 0, mult_gain = 6}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_cardslinger=      {order = 181,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Cardslinger", pos = {x=4,y=16}, set = "Joker", effect = "", config = {extra = {trigger_count = 0, chips = 10, clear_cache = false}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_pitiful=          {order = 182,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Pitiful Joker", pos = {x=2,y=18}, set = "Joker", effect = "", config = {extra = {mult = 10}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_sunday_funnies=   {order = 183,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Sunday Funnies", pos = {x=7,y=18}, set = "Joker", effect = "", config = {extra = {counter = 2}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_bottled_buffoon=  {order = 184,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Bottled Buffoon",    pos = {x=1,y=21}, set = "Joker", effect = "", config = {extra = {every = 3, remaining = "3 remaining"}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_mutated_joker=    {order = 185,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Mutated Joker",      pos = {x=2,y=21}, set = "Joker", effect = "", config = {extra = {chips = 10, total_chips = 10}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_chain_reaction=   {order = 186,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Chain Reaction",     pos = {x=3,y=21}, set = "Joker", effect = "", config = {extra = {used = false}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_essence_of_comedy={order = 187,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Essence of Comedy",  pos = {x=4,y=21}, set = "Joker", effect = "", config = {extra = 0.1, Xmult = 1},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_shock_humor=      {order = 188,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Shock Humor",        pos = {x=5,y=21}, set = "Joker", effect = "", config = {extra = {odds = 5}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_breaking_bozo=    {order = 189,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 7, name = "Breaking Bozo",      pos = {x=6,y=21}, set = "Joker", effect = "", config = {},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_studious_joker=   {order = 190,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Studious Joker",     pos = {x=0,y=21}, set = "Joker", effect = "", config = {mult = 4},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        j_catalyst_joker=   {order = 191,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 6, name = "Catalyst Joker",     pos = {x=7,y=21}, set = "Joker", effect = "", config = {extra = {slots = 1, bonus = 0.5}},  unlock_condition = {type = '', extra = '', hidden = true}},                                                                                                                                                                                                                                                                                                
        ...
        c_seeker=           {order = 23,    discovered = false, cost = 3, consumeable = true, name = "The Seeker", pos = {x=7,y=5}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, config = {alchemicals = 2}},
        ...
        c_incense=          {order = 19,   discovered = true,  cost = 4, consumeable = true, name = "Incense", pos = {x=6,y=5}, set = "Spectral", config = {extra = {dollars = 50 , j_slots = 1 , increase = 25}}, hidden = true},
        c_philosopher_stone={order = 20,   discovered = true,  cost = 4, consumeable = true, name = "Philosopher Stone", pos = {x=8,y=5}, set = "Spectral", config = {}, hidden = true},
        

        --Alchemicals
        c_ignis=            {order = 1,   discovered = true,  cost = 3, consumeable = true, name = "Ignis",         pos = {x=0,y=0}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_aqua=             {order = 2,   discovered = true,  cost = 3, consumeable = true, name = "Aqua",          pos = {x=1,y=0}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_terra=            {order = 3,   discovered = true,  cost = 3, consumeable = true, name = "Terra",         pos = {x=2,y=0}, set = "Alchemical", config = {}, hidden = true},
        c_aero=             {order = 4,   discovered = true,  cost = 3, consumeable = true, name = "Aero",          pos = {x=3,y=0}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_quicksilver=      {order = 5,   discovered = true,  cost = 3, consumeable = true, name = "Quicksilver",   pos = {x=4,y=0}, set = "Alchemical", config = {extra = 2}, hidden = true},
        c_salt=             {order = 6,   discovered = true,  cost = 3, consumeable = true, name = "Salt",          pos = {x=5,y=0}, set = "Alchemical", config = {extra = 2}, hidden = true},
        c_sulfur=           {order = 7,   discovered = true,  cost = 3, consumeable = true, name = "Sulfur",        pos = {x=0,y=1}, set = "Alchemical", config = {extra = 10}, hidden = true},
        c_phosphorus=       {order = 8,   discovered = true,  cost = 3, consumeable = true, name = "Phosphorus",    pos = {x=1,y=1}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_bismuth=          {order = 9,   discovered = true,  cost = 3, consumeable = true, name = "Bismuth",       pos = {x=2,y=1}, set = "Alchemical", config = {extra = 2}, hidden = true},
        c_cobalt=           {order = 10,  discovered = true,  cost = 3, consumeable = true, name = "Cobalt",        pos = {x=3,y=1}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_arsenic=          {order = 11,  discovered = true,  cost = 3, consumeable = true, name = "Arsenic",       pos = {x=4,y=1}, set = "Alchemical", config = {}, hidden = true},
        c_antimony=         {order = 12,  discovered = true,  cost = 3, consumeable = true, name = "Antimony",      pos = {x=5,y=1}, set = "Alchemical", config = {}, hidden = true},
        c_soap=             {order = 13,  discovered = true,  cost = 3, consumeable = true, name = "Soap",          pos = {x=0,y=2}, set = "Alchemical", config = {extra = 3}, hidden = true},
        c_manganese=        {order = 14,  discovered = true,  cost = 3, consumeable = true, name = "Manganese",     pos = {x=1,y=2}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_wax=              {order = 15,  discovered = true,  cost = 3, consumeable = true, name = "Wax",           pos = {x=2,y=2}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_borax=            {order = 16,  discovered = true,  cost = 3, consumeable = true, name = "Borax",         pos = {x=3,y=2}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_glass=            {order = 17,  discovered = true,  cost = 3, consumeable = true, name = "Glass",         pos = {x=4,y=2}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_magnet=           {order = 18,  discovered = true,  cost = 3, consumeable = true, name = "Magnet",        pos = {x=5,y=2}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_gold=             {order = 19,  discovered = true,  cost = 3, consumeable = true, name = "Gold",          pos = {x=0,y=3}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_silver=           {order = 20,  discovered = true,  cost = 3, consumeable = true, name = "Silver",        pos = {x=1,y=3}, set = "Alchemical", config = {extra = 4}, hidden = true},
        c_oil=              {order = 21,  discovered = true,  cost = 3, consumeable = true, name = "Oil",           pos = {x=2,y=3}, set = "Alchemical", config = {}, hidden = true},
        c_acid=             {order = 22,  discovered = true,  cost = 3, consumeable = true, name = "Acid",          pos = {x=3,y=3}, set = "Alchemical", config = {extra = 1}, hidden = true},
        c_brimstone=        {order = 23,  discovered = true,  cost = 3, consumeable = true, name = "Brimstone",     pos = {x=4,y=3}, set = "Alchemical", config = {extra = 2}, hidden = true},
        c_uranium=          {order = 24,  discovered = true,  cost = 3, consumeable = true, name = "Uranium",       pos = {x=5,y=3}, set = "Alchemical", config = {extra = 1}, hidden = true},
        ...
        v_mortar_and_pestle={order = 33,    discovered = false, unlocked = true , available = true, cost = 10, name = "Mortar and Pestle", pos = {x=8,y=0}, set = "Voucher", config = {extra = 1}},
        v_alchemical_merchant={order = 35,    discovered = false, unlocked = true , available = true, cost = 10, name = "Alchemical Merchant", pos = {x=9,y=0}, set = "Voucher", config = {extra = 4.8/4}},
        ...
        v_cauldron=         {order = 34,    discovered = false, unlocked = false, available = true, cost = 10, name = "Cauldron", pos = {x=8,y=1}, set = "Voucher", config = {}, requires = {'v_mortar_and_pestle'},unlock_condition = {type = 'discover_amount', amount = 20}},
        v_alchemical_tycoon={order = 36,    discovered = false, unlocked = true , available = true, cost = 10, name = "Alchemical Merchant", pos = {x=9,y=1}, set = "Voucher", config = {extra = 9,6/4}, requires = {'v_alchemical_merchant'},unlock_condition = {type = 'discover_amount', amount = 20}},
        ...
        b_philosopher=      {name = "Philosopher's Deck",     stake = 1, unlocked = true,order = 16, pos = {x=0,y=5}, set = "Back", config = {vouchers = { 'v_alchemical_merchant' }, consumables = { 'c_seeker' }}, unlock_condition = {type = 'discover_amount', amount = 20}},
        b_herbalist=        {name = "Herbalist's Deck", stake = 1, unlocked = true,order = 16, pos = {x=1,y=5}, set = "Back", config = {vouchers = { 'v_mortar_and_pestle' }}, unlock_condition = {type = 'discover_amount', amount = 20}},
        ...
        p_alchemy_normal_1 =       {order = 29, discovered = false, name = "Alchemy Pack", weight = 1, kind = 'Celestial', cost = 4, pos = {x=0,y=0}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_alchemy_normal_2 =       {order = 30, discovered = false, name = "Alchemy Pack", weight = 1, kind = 'Celestial', cost = 4, pos = {x=1,y=0}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_alchemy_normal_3 =       {order = 31, discovered = false, name = "Alchemy Pack", weight = 1, kind = 'Celestial', cost = 4, pos = {x=2,y=0}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_alchemy_normal_4 =       {order = 32, discovered = false, name = "Alchemy Pack", weight = 1, kind = 'Celestial', cost = 4, pos = {x=3,y=0}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_alchemy_jumbo_1 =        {order = 33, discovered = false, name = "Jumbo Alchemy Pack", weight = 1, kind = 'Celestial', cost = 6, pos = {x=0,y=1}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_alchemy_jumbo_2 =        {order = 34, discovered = false, name = "Jumbo Alchemy Pack", weight = 1, kind = 'Celestial', cost = 6, pos = {x=1,y=1}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_alchemy_mega_1 =         {order = 35, discovered = false, name = "Mega Alchemy Pack", weight = 0.25, kind = 'Celestial', cost = 8, pos = {x=2,y=1}, atlas = 'Alchemy_Booster', set = 'Booster', config = {extra = 4, choose = 2}},
    
        --Extras       
        soul={pos = {x=0,y=1}},
        undiscovered_joker={pos = {x=5,y=3}},
        undiscovered_tarot={pos = {x=6,y=3}},
        undiscovered_alchemical={pos = {x=0,y=0}, atlas = 'Alchemy_undiscovered'},
    }
    ...
    table.sort(self.P_CENTER_POOLS["Alchemical"], function (a, b) return a.order < b.order end)
...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.FONTS = {
            ...
            {file = "resources/fonts/NotoSans-Bold.ttf", render_scale = self.TILESIZE*10, TEXT_HEIGHT_SCALE = 0.65, TEXT_OFFSET = {x=0,y=-40}, FONTSCALE = 0.12, squish = 1, DESCSCALE = 1},
...
function Game:set_render_settings()
    ...
    self.asset_atli = {
        ...
        {name = "Alchemical", path = "resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/alchemical_atlas.png",px=71,py=95},
        {name = "Alchemy_Booster", path = "resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/ca_booster_atlas.png",px=71,py=95},
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    ...
    local replace_card = Card(self.title_top.T.x, self.title_top.T.y, 1.2*G.CARD_W*SC_scale, 1.2*G.CARD_H*SC_scale, G.P_CENTERS.j_business, G.P_CENTERS.j_business)
    self.title_top:emplace(replace_card)
    replace_card:set_eternal(true)
    replace_card:set_edition({polychrome = true}, true, true)
